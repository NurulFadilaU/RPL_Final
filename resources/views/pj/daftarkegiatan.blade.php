        ...
        <aside id="sidebar"
            ...
            <nav class="w-full">
                <ul class="text-center space-y-2">
                    ...
                    <li class="py-2 lg:py-4 cursor-pointer hover:bg-orange-300 transition rounded-lg">Evaluasi Kegiatan
                    </li>
                </ul>
            </nav>
                ...
                <div class="border-2 border-orange-500 rounded-xl p-6 mb-6">
                    <div class="flex flex-wrap gap-6 items-center justify-between w-full">
                        ...
                        <div class="flex flex-wrap gap-4 items-center">
                            ...
                            <form action="{{ route('pjdaftarkegiatan.index') }}" method="GET"
                                ...
                                @forelse ($kegiatan as $item)
                                    <tr class="text-center border-b border-orange-500  text-sm">
                                        ...
                                        <td rowspan="2" class="p-2 border border-orange-500">
                                            ...
                                            <!-- Tombol Delete -->
                                            <form action="{{ route('pjdaftarkegiatan.destroy', $item->id_kegiatan) }}"
